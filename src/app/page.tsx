...
export default function LandingPage() {
      ...
      testimonials={[
        {
          name: "Alice Johnson",
          handle: "@smallbiz",
          testimonial: "Kinza completely transformed our brand. The results were professional and delivered fast.",
          rating: 5,
        ...
        },
        {
          name: "Mark Stevens",
          handle: "@localstore",
          testimonial: "Excellent graphic design service. Understood exactly what our business needed.",
          rating: 5,
        ...
        },
        {
          ...
          testimonial: "Highly recommended for any business looking for standout branding and graphic support.",
          rating: 5,
        ...
        },
        {
          name: "David Park",
          handle: "@startupinc",
          testimonial: "Creative, reliable, and professional. Kinza is our go-to for design projects.",
          rating: 5,
        ...
        },
        {
          name: "Elena Ross",
          handle: "@elena_design",
          testimonial: "Truly exceptional service. Kinza makes the process seamless and the design aesthetic is always on-point.",
          rating: 5,
  ...
  <div id="services" data-section="services">
      ...
      features={[
        {
          title: "Logo Design",
          description: "Memorable logos that capture your business identity.",
        ...
        },
        {
          ...
          imageSrc: "http://img.b2bpic.net/free-photo/white-grey-business-cards_23-2148500495.jpg",
        },
        {
          title: "Social Media Graphics",
          description: "Engagement-driven visuals for your platforms.",
          imageSrc: "http://img.b2bpic.net/free-vector/marketing-designs-collection_1209-75.jpg",
        },
        {
          title: "Print Design",
          description: "Professional flyers, brochures, and cards.",
          imageSrc: "http://img.b2bpic.net/free-photo/view-party-decorations-arrangement_23-2148698114.jpg",
        },
        {
          title: "Website/UI Graphics",
          description: "Clean, conversion-ready design for digital interfaces.",
        ...
        },
        {
          ...
          description: "Tailored solutions for your specific marketing needs.",
  ...
  <div id="portfolio" data-section="portfolio">
      ...
      products={[
        {
          id: "1",
          name: "Branding Project Alpha",
          price: "Logo Design",
          imageSrc: "http://img.b2bpic.net/free-photo/stationery-concept_23-2147800657.jpg",
        },
        {
          id: "2",
          name: "Social Campaign Beta",
          price: "Social Graphics",
          imageSrc: "http://img.b2bpic.net/free-psd/flat-design-thrift-store-template_23-2150082692.jpg",
        },
        {
          id: "3",
          name: "Print Series Gamma",
          price: "Print Collateral",
        ...
        },
        {
          ...
          name: "Web UI Delta",
          price: "UI Design",
          imageSrc: "http://img.b2bpic.net/free-photo/woman-with-editor-occupation-wearing-headphones_482257-10564.jpg",
        },
        {
          id: "5",
          name: "Identity Project Epsilon",
          price: "Branding",
          imageSrc: "http://img.b2bpic.net/free-vector/corporate-brand-design-set-envelopes-tshirts-stationary-more-black-colour_613284-218.jpg",
        },
        {
          id: "6",
          name: "Marketing Visual Zeta",
          price: "Design Asset",
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      testimonials={[
        ...
        },
        {
          ...
          quote: "Professional, fast, and creative work.",
          name: "Mark Stevens",
          role: "CEO, LocalStore",
        ...
        },
        {
          ...
          quote: "Our brand identity has never looked better.",
          name: "Sarah Lee",
        ...
        },
        {
          ...
          quote: "Exceeded all our goals for the project.",
          name: "David Park",
          role: "Lead Startup Dev",
          imageSrc: "http://img.b2bpic.net/free-photo/couple-watching-online-recipe-laptop-kitchen-vegetables-salad-man-helping-woman-prepare-healthy-organic-dinner-cooking-together-romantic-cheerful-love-relationship_482257-12127.jpg",
        },
        {
          id: "5",
          title: "Friendly & Efficient",
          quote: "Easy to communicate with and super helpful.",
          name: "Jane Doe",
          role: "Client",
      ...
      faqs={[
        {
          ...
          content: "Just click the 'Get a Free Quote' button on any page and fill out the quick form.",
        },
        {
          id: "f2",
          title: "What is your turnaround time?",
          content: "Turnaround depends on the project scope, but we aim for fast delivery for every request.",
        },
        {
          id: "f3",
          title: "Do you offer revisions?",
          content: "Yes, we include revisions to ensure complete satisfaction with the design results.",
        },
      ]}
